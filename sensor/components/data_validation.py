...
class DataValidation:
    ...
    def __init__(self,data_ingestion_artifact:DataIngestionArtifact,
        ...
        try:
            ...
            #Schema confif is a protected variable used only for this class purpose
        ...
        try:
            ...
            for num_col in numerical_columns:
                if num_col not in dataframe_columns:
                    ...
                    missing_columns.append(num_col) 
                    logging.info(f"Missing numerical columns: [{missing_columns}]")
            logging.info("No Missing Numerical columns are present")
            return numerical_column_present
        except Exception as e:
            raise SensorException(e,sys)

    def detect_dataset_drift(self,base_df,current_df,threshold=0.6) ->bool:
        try:
            status = True
            report ={}
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        try:
            ...
            logging.info("Succesfully completed Data Validation Component")
